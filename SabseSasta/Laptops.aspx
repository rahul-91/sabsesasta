<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Laptops.aspx.cs" Inherits="SabseSasta.Laptops" %>
        ...
        <tr>
            ...
            <td class="auto-style8">
                <table style="width:100%;">
                    <tr>
                        <td colspan="4">
                            <asp:Label ID="Label12" runat="server" Text="Laptops"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:ImageButton ID="ImageButton5" runat="server" ImageUrl="~/Pictures/electronic/pics5.jpg" OnClick="ImageButton5_Click" />
                        </td>
                        <td>
                            <asp:ImageButton ID="ImageButton6" runat="server" ImageUrl="~/Pictures/electronic/pics6.jpg" />
                        </td>
                        <td>
                            <asp:ImageButton ID="ImageButton7" runat="server" ImageUrl="~/Pictures/electronic/pics7.jpg" />
                        </td>
                        <td>
                            <asp:ImageButton ID="ImageButton8" runat="server" ImageUrl="~/Pictures/electronic/pics8.jpg" />
                        </td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
