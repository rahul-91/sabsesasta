<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="SabseSasta.Index" %>
        ...
        <tr>
            ...
            <td class="auto-style8">
                <table style="width:100%;">
                    ...
                    <tr>
                        <td>
                            <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/Pictures/electronic/pics1.jpg" OnClick="ImageButton1_Click" CausesValidation="False" />
                        </td>
                        <td>
                            <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/Pictures/electronic/pics2.jpg" OnClick="ImageButton2_Click" CausesValidation="False"/>
                        </td>
                        <td>
                            <asp:ImageButton ID="ImageButton3" runat="server" ImageUrl="~/Pictures/electronic/pics3.jpg" OnClick="ImageButton3_Click" CausesValidation="False" />
                        </td>
                        <td>
                            <asp:ImageButton ID="ImageButton4" runat="server" ImageUrl="~/Pictures/electronic/pics4.jpg" OnClick="ImageButton4_Click" CausesValidation="False" />
                        </td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
